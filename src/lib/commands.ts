    ...
    if (sub === "1") {
      return {
        ...
        lines: [
          ...
          "    — Target acquired: LLAMA PARADE (band site)",
          "    — Stack: v0 + GitHub + Vercel",
          "    — Feature payload: About · Upcoming Shows · Setlists · Videos · Book Us",
          "",
          "  STATUS: IN PROGRESS — target: llamaparade.com.",
          "           Solo deployment underway. Agent on own branch.",
          "",
          ">>> END TRANSMISSION <<<",
        ],
      };
